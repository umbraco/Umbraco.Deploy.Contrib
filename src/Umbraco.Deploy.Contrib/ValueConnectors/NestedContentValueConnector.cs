...
/// <summary>
/// A Deploy connector for the Nested Content property editor.
/// </summary>
/// <seealso cref="Umbraco.Deploy.Core.Connectors.ValueConnectors.ValueConnectorBase" />
[Obsolete("Deploy 10.3.0 adds an explicit binding to use Umbraco.Deploy.Infrastructure.Connectors.ValueConnectors.NestedContentValueConnector instead to support recursive migrators. This class will be removed in a future version.")]
public class NestedContentValueConnector : ValueConnectorBase
{
    ...
    /// <inheritdoc />
    /// <remarks>
    /// Our.Umbraco.NestedContent is the original NestedContent package Umbraco.NestedContent is Core NestedContent (introduced in v7.7).
    /// </remarks>
    ...
    public class NestedContentValue
    {
        ...
        /// </summary>
        /// <remarks>
        /// The JsonExtensionDataAttribute is used to put the non-typed properties into a bucket (http://www.newtonsoft.com/json/help/html/DeserializeExtensionData.htm).
        /// NestedContent serializes to string, int, whatever e.g. <c>"stringValue":"Some String","numericValue":125,"otherNumeric":null</c>.
        /// </remarks>
        [JsonExtensionData]
